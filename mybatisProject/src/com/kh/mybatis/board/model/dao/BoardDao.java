...
public class BoardDao {
	...
	public ArrayList<Reply> selectReplyList(SqlSession sqlSession, int boardNo) {
		...
		return (ArrayList)sqlSession.selectList("boardMapper.selecReplyList",boardNo);
	}
	...
	public ArrayList<Board> selectsearchBoard(SqlSession sqlSession,HashMap<String, String> map, PageInfo pi) {
		...
		ArrayList<Board> list = (ArrayList)sqlSession.selectList("boardMapper.selectBoardList",map,rowBounds);
